...
import AboutWidgetPosts from './AboutWidgetPosts';
import AboutWidgetTwitter from './AboutWidgetTwitter';
import AboutWidgetGallery from './AboutWidgetGallery';
        ...
        <div className="container">
          <div className="footer-top">
            ...
            <div className="row">
              ...
              <div className="col-md-3 col-sm-6">
                {}
                <AboutWidgetPosts></AboutWidgetPosts>
                {}
              </div>
              <div className="col-md-3 col-sm-6">
                {}
                <AboutWidgetTwitter></AboutWidgetTwitter>
                {}
              </div>
              <div className="col-md-3 col-sm-6">
                {}
                <AboutWidgetGallery></AboutWidgetGallery>
                {}
              </div>
            </div>
          </div>
