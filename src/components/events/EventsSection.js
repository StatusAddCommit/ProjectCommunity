                ...
                <div className="event-content">
                  ...
                  <div className="event-description" itemProp="description">
                    <p>
                      ...
                      Lorem ipsum dolor sit amet. Lorem ipsum dolor sit ame. At
            ...
            >
              <div className="boxed flip-front">
                <a
                  ...
                  itemProp="url"
                >
                  <img src="images/temp/event-3.jpg" alt itemProp="image" />
                </a>
                <div className="event-content">
                  <h3 className="event-title" itemProp="name">
                    <a href="event-details.html">Here goes the Event Title</a>
            ...
            >
              <div className="boxed flip-front">
                <a
                  ...
                  itemProp="url"
                >
                  <img src="images/temp/event-4.jpg" alt itemProp="image" />
                </a>
                <div className="event-content">
                  <h3 className="event-title" itemProp="name">
                    <a href="event-details.html">Here goes the Event Title</a>
            ...
            >
              <div className="boxed flip-front">
                <a
                  ...
                  itemProp="url"
                >
                  <img src="images/temp/event-5.jpg" alt itemProp="image" />
                </a>
                <div className="event-content">
                  <h3 className="event-title" itemProp="name">
                    <a href="event-details.html">Here goes the Event Title</a>
            ...
            >
              <div className="boxed flip-front">
                <a
                  ...
                  itemProp="url"
                >
                  <img src="images/temp/event-6.jpg" alt itemProp="image" />
                </a>
                <div className="event-content">
                  <h3 className="event-title" itemProp="name">
                    <a href="event-details.html">Here goes the Event Title</a>
