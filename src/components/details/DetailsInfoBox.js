...
class DetailsInfoBox extends React.Component {
  render() {
    return (
      <article
          ...
          <div className="event-content">
            ...
            <ul className="event-location">
              ...
              <li>
                ...
                <time
                  ...
                  itemProp="startDate"
                >
                  <i className="material-icons">query_builder</i>12 Dec 2016,
                  11:00 AM
                </time>
              </li>
            </ul>
            <div className="event-description" itemProp="description">
              <p>
                ...
                dolor sit amet. Lorem ipsum dolor sit ame. At vero eos et
